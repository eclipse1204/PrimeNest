...
export default function Header() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    const urlParams = new URLSearchParams(window.location.search); //gives all the url parameters
  ...
  useEffect(() => {
    const urlParams = new URLSearchParams(window.location.search); //gives the url parameters
